...
router.get('/', (req, res) => {
  res.json({
    ...
    features: {
      f1:'Agency Workspace', f2:'AI Conversion Intelligence',
      f3:'Regional Languages', f4:'60-Second Callback',
      f5:'Virtual Tour Embed', f6:'White-label Platform',
      f7:'Portal API', f8:'AI Optimizer', f9:'Builder Suite',
    },
  });
});
